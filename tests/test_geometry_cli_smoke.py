...
def test_cli_runs_and_writes_stage2_outputs(tmp_path, stage1_stage0_root):
    ...
    expected_paths = [
        ...
        stage2_root / "qc" / "stimulus_overlap__date.parquet",
        stage2_root / "qc" / "stimulus_overlap__individual.parquet",
        stage2_root / "figures" / "rdm_matrix__response_window__pooled.png",
        stage2_root / "figures" / "rdm_matrix__response_window__pooled__clustered.png",
        stage2_root / "figures" / "rdm_matrix__full_trajectory__pooled.png",
        stage2_root / "figures" / "rdm_matrix__full_trajectory__pooled__clustered.png",
        ...
        stage2_root / "figures" / "stimulus_overlap__date.png",
        stage2_root / "figures" / "stimulus_overlap__individual.png",
